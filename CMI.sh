...
cat << EOF
    ...
    Welcome to Cellframe Masternode installation script.

    This script will install Cellframe Node to your computer and configure a master role in selected network.

    Cellframe Masternode installation script will attempt to locate a .dwallet file in the same directory where it is located.
...
showinfo() {
    ...
    printf "%s Cellframe Masternode installation script launched.\n" "---"
